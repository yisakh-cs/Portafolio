...
{
    public partial class frm_BuscarVete : Form
    {
        public frm_BuscarVete()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                sw = File.OpenText("veterinarios.txt");
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            File.Delete("veterinarios.txt");
            File.Move("tmp.txt", "veterinarios.txt");
        }
    }
}
