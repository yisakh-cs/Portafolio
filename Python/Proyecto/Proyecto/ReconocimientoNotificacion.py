...
to_number = 'whatsapp:+50688665650'  # Reemplaza con el número de teléfono de WhatsApp al que quieres enviar el mensaje
...
image_url = 'C:/Users/yisak/Documents/Python/Proyecto/Temp/imagen.jpg'  # Reemplaza con la URL de la imagen que deseas enviar
...
while True:
	...
	for (x,y,w,h) in faces:
		...
		if result[1] < 69:
			...
			if countmsj==0 :
				cv2.imwrite(dataPathTemp + '/imagen.jpg',rostro)
