...
<html lang="en" dir="ltr">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Cedula del representante</th>
    </tr>
  </thead>
  <tbody>
    <?php
    $cliente = $infoProycto['cedula'];
    $post= $this->mdl_usuarios->get_cliente($cliente);
 ...
 foreach ($post as $key) {
   // code...
           ...
           <tr>
               ...
               <tr><td scope="row"><?php echo $key['cedulaJuridica']; ?></td>
             <td><?php echo $key['nombreOrganizacion']; ?></td>
