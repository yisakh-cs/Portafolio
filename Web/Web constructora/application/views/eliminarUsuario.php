          ...
          <div class="row">
            ...
            <div class="span12">
              <h2>Datos Usuario</h2>
                ...
                echo form_open('Main/eliminarUsuario');
                      echo validation_errors(); ?>
                ...
                <label for=""class="Datos">Apellidos</label>
                <br>

                <input class="form-control  btn btn-dark" type="submit" id = "Eliminar" name="submit" value="Eliminar" />
                </form>
