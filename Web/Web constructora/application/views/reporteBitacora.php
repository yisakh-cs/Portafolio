...
<div style="margin-top: 30px" class="span3">
    ...
    <div class="span10">
      ...
      <div class="row">
        ...
        <table id = "tableBitacora" class="table table-hover table table-dark">
            <thead>
              <tr>
                ...
                <th scope="col">Crear comentario</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              $post= $this->mdl_proyectos->get_bitacora($dato);
           ...
           foreach ($post as $key) {
             // code...
                     ...
                     ?>
                      ...
                      ?>
                      <td> <a href="<?php echo site_url('Main/comentarios/'.$key['idBitacora']); ?>">Link </a></td>
                      </tr>
...
<div class="row">
    <div class="row space10">
      ...
      <input class="form-control" type="text" id = "bitacora" name="bitacora" placeholder="Escribe algo para buscar"  /><br />
      <script>
          $(document).ready(function(){
            $("#bitacora").on("keyup", function() {
              var value = $(this).val().toLowerCase();
              $("#tableBitacora tr").filter(function() {
