          ...
          <div class="row">
            ...
            <div class="span12">
              <h2>Datos de recibo</h2>
                ...
                echo form_open('Main/crearRecibo');
                      echo validation_errors(); ?>
                <!-- Declaramos los input para usuario y contraseña-->
                <label for="" class = "Datos">Hecho por: </label>
                <label class="Datos"><?php echo $info['nombrePersona'],' ',$info['apellido'],' ',$info['apellido2'] ;?></label><br />
                <!-- Declaramos un hidden para la cedula-->
                <input class="hidden" value="<?php echo $info['cedula']; ?>" name="cedulaUsuario" id="cedulaUsuario">
                <!-- Declaramos un hidden para la idProyecto-->
                <input class="hidden" value="<?php echo $Proyecto['idProyecto']; ?>" name="idProyecto" id="idProyecto">

                <label for="" class = "Datos">Monto total de proyecto:</label>
                <label class="Datos" name=""><?php echo $Proyecto['costoTotal'] ?></label>
                <label for="" class = "Datos">Monto a Pagar</label>
                <input type="text" class="form-control" name="montoPago" id="montoPago" value="">
                <label for="" class = "Datos">Fecha vencimiento</label>
                <input type="date" class="form-control" name="fecha" id="fecha" value="">
                <label for="" class = "Datos">Mes</label>
                <input type="text" class="form-control" name="mes" id="mes" value="">
