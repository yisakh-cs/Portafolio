          ...
          <div class="row">
            ...
            <div class="span12">
              <h2>Cobro</h2>
                ...
                echo form_open('Main/pagoRecibo');
                      echo validation_errors(); ?>
                <!-- Declaramos los input para usuario y contraseña-->
                <label for="" class = "Datos">idRecibo:</label>
                <input class="form-control" type="input" id = "idRecibo" name="idRecibo" /><br />
                <label for="" class = "Datos">Monto a Cobrar:</label>
                <input class="form-control" type="input" id = "montoPago" name="montoPago" /><br />
                <label for=""class="Datos">Fecha</label>
                <input class="form-control" type="date" id = "fechaPago" name="fechaPago" /><br />

                <br>

                <input class="form-control  btn btn-dark" type="submit" id = "Pagar" name="submit" value="Pagar" />
                </form>
